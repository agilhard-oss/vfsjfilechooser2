 ...
 * under the License.
 */
package net.agilhard.vfsjfilechooser2.demo;


import net.agilhard.vfsjfilechooser2.VFSJFileChooser;
import org.apache.commons.vfs2.FileObject;

import net.agilhard.vfsjfilechooser2.accessories.DefaultAccessoriesPanel;
...
public final class Main extends JFrame implements Runnable
{
    ...
    private class OpenAction extends AbstractAction
    {
        ...
        public void actionPerformed(ActionEvent actionEvent)
        {
            ...
            VFSJFileChooser.RETURN_TYPE answer = fileChooser.showOpenDialog(Main.this);
