...
import net.agilhard.vfsjfilechooser2.accessories.connection.Credentials;
import net.agilhard.vfsjfilechooser2.accessories.connection.Credentials.Builder;
import net.agilhard.vfsjfilechooser2.accessories.connection.Protocol;
import net.agilhard.vfsjfilechooser2.filechooser.PopupHandler;
import net.agilhard.vfsjfilechooser2.utils.VFSResources;
import net.agilhard.vfsjfilechooser2.utils.VFSURIParser;
...
public final class BookmarksEditorPanel extends JPanel {
	...
	private JComboBox<Protocol> protocolList;
	...
	private void initCenterPanelComponents() {
		...
		DefaultComboBoxModel<Protocol> protocolModel = new DefaultComboBoxModel<Protocol>(Protocol
				.values());
