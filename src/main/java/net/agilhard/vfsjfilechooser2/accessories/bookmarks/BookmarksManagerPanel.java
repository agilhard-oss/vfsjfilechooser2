...
public class BookmarksManagerPanel extends JPanel
{
        ...
        VFSJFileChooser chooser)
    {
        ...
        bOpen.setIcon(new ImageIcon(getClass()
                                        .getResource("/net/agilhard/vfsjfilechooser2/plaf/icons/document-open.png")));
        ...
        bAdd.setIcon(new ImageIcon(getClass()
                                       .getResource("/net/agilhard/vfsjfilechooser2/plaf/icons/list-add.png")));
        ...
        bEdit.setIcon(new ImageIcon(getClass()
                                        .getResource("/net/agilhard/vfsjfilechooser2/plaf/icons/book_edit.png")));
        ...
        bDelete.setIcon(new ImageIcon(getClass()
                                          .getResource("/net/agilhard/vfsjfilechooser2/plaf/icons/list-remove.png")));
        ...
        bMoveUp.setIcon(new ImageIcon(getClass()
                                          .getResource("/net/agilhard/vfsjfilechooser2/plaf/icons/go-up.png")));
        ...
        bMoveDown.setIcon(new ImageIcon(getClass()
                                            .getResource("/net/agilhard/vfsjfilechooser2/plaf/icons/go-down.png")));
